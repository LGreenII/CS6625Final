...
# Knowledgebase creation counter
kb_counter = 0
...
def create_vector_db():
    ...
    loader = CSVLoader(file_path="prompt_answer.csv", csv_args={"delimiter": ",", "quotechar": '"'})
    data = loader.load()
...
def general_computer_science(question):
    prompt = f'''{question}
            
            Using the internet or any other source of information, answer the question to the best of your ability.
            Make sure the answer is accurate and concise.'''
